...
public class DESConstants{
    ...
    //Note: these Have been changed from one based to zero based
    //P is used to permutate output of feistel 
	public static final int[]  P =     {15,   6,  19,  20,  28,  11,  27,  16,
	...
	public static final int[] PC1 =    {56,  48,  40,  32,  24,  16,   8,
                                         0,  57,  49,  41,  33,  25,  17,
                                         9,   1,  58,  50,  42,  34,  26,
                                        18,  10,   2,  59,  51,  43,  35,
    ...
    public static final int[] PC2 =    {13,  16,  10,  23,   0,   4,   2,  27,  
    ...
    public static final int[]  IP =    {57, 49, 41, 33, 25, 17,  9, 1,
    ...
    public static final int[] EP =     {31,  0,  1,  2,  3,  4,
                                         3,  4,  5,  6,  7,  8,
                                         7,  8,  9, 10, 11, 12,
                                        11, 12, 13, 14, 15, 16,
                                        15, 16, 17, 18, 19, 20,
    ...
    //amounts to shift key by 
    //shifts performed after each subKey generation                               
    public static final int[] LEFT_SHIFTS =  {1, 1, 2, 2, 2, 2, 2, 2, 
     										  1, 2, 2, 2, 2, 2, 2, 1};

    //Substitution Boxes
    //SBoxes 0-7 for each of the 8 6bit chunks of XOR(EP(Rx),Kx)
